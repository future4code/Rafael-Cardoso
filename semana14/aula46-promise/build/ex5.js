...
var sendNotification = function (subscribers, message) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, subscribers_1, item, subscriberId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(_i < subscribers_1.length)) return [3, 4];
                item = subscribers_1[_i];
                subscriberId = item.id;
                return [4, axios_1.default.post(baseUrl + "/notifications/send", { subscriberId: subscriberId, message: message })];
            case 2:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, sendNotification(allSubscribers, 'Bem-vindos!')];
            case 2:
                _a.sent();
